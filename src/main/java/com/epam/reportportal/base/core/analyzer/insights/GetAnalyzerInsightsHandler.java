...
public interface GetAnalyzerInsightsHandler {

  AnalyzerInsightsRs getLaunchInsights(MembershipDetails membershipDetails, Long launchId,
      Long compareToId, int historyDepth);

  AnalyzerItemFlakinessRs getItemFlakiness(MembershipDetails membershipDetails, Long itemId,
      int historyDepth);
}